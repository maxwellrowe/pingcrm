<template>
  <div>
    <Head title="Lightcast API" />
    <h1 class="mb-8 text-3xl font-bold">Lightcast Data APIs</h1>

    <p class="mb-8 leading-normal">Data APIs are views to utilize various Lightcast APIs.</p>
